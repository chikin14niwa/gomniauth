...
const (
	lineKeyMID        string = "mid"
	lineKeyName       string = "nickname"
	lineKeyNickname   string = "nickname"
	lineKeyEmail      string = "email"
	lineKeyPictureUrl string = "picture.data.url"
)
...
func NewUser(data objx.Map, creds *common.Credentials, provider common.Provider) *User {
	...
	creds.Set(common.CredentialsKeyID, data[lineKeyMID])
...
func (u *User) Email() string {
	return u.Data().Get(lineKeyEmail).Str()
}

// Name gets the users full name.
func (u *User) Name() string {
	return u.Data().Get(lineKeyName).Str()

}

// Nickname gets the users nickname or username.
func (u *User) Nickname() string {
	return u.Data().Get(lineKeyNickname).Str()

}

// AvatarURL gets the URL of an image representing the user.
func (u *User) AvatarURL() string {
	return u.Data().Get(lineKeyPictureUrl).Str()
}
